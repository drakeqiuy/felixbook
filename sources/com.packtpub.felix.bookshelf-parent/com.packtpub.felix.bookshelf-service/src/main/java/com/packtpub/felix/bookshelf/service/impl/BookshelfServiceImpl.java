...
public class BookshelfServiceImpl implements BookshelfService {
	...
	@Override
	public void addBook(String sessionId, String isbn, String title,
	...
	@Override
	public void modifyBookCategory(String sessionId, String isbn,
			String category) throws BookNotFoundException, InvalidBookException {
	...
	@Override
	public Set<String> searchBooksByRating(String sessionId, int gradeLower,
			int gradeUpper) {
