...
public interface BookshelfServiceProxy {
	...
	public String add(String username, String password, String isbn, String title,
	...
	public Set<Book> search(String username, String password, String attribute,
			String filter) throws InvalidCredentialsException;

	public Set<Book> search(String username, String password, String attribute,
			int lower, int upper) throws InvalidCredentialsException;
